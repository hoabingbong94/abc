...
function muahangnhanh() {
    ...
    echo "<a data-popup-open='muahangnhanh' href='#'><div class='detailcall-1'><h3>ĐĂNG KÍ LÀM ĐẠI LÝ</h3><span>Giao hàng tận nơi miễn phí nội thành!</span></div></a>
        <div class='popup' data-popup='muahangnhanh'>
            <div class='popup-inner'>
                <div id='contact_form_pop'>
		    	<div class='form-title'>
			      	<h3>Đăng kí làm đại lý phân phối khô gà xé cay</h3>
					<p>Hoặc gọi trực tiếp 024 23.23.24.25 để được tư vấn chính xác nhất!</p>
					<hr>
			    </div>
