...
while ( $recentPosts->have_posts() ) : $recentPosts->the_post();
		...
		<div class="col <?php echo implode(' ', $col_class); ?>" <?php echo $animate;?>>
          ...
          <?php } ?>
					...
					<p style="text-align: justify" class="from_the_blog_excerpt <?php if($excerpt !== 'visible'){ echo 'show-on-hover hover-'.$excerpt; } ?>"><?php
					  $the_excerpt = get_the_excerpt();
                      $excerpt_length = 150;
                      $data = flatsome_string_limit_words($the_excerpt, $excerpt_length);
